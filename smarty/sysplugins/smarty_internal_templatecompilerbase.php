...
abstract class Smarty_Internal_TemplateCompilerBase
{
    ...
    /**
     * tpl编译成的php文件中添加一个，用于include模块的方法 Method to compile a Smarty template
     *
    ...
    public function compileTemplate(Smarty_Internal_Template $template, $nocache = false)
    {
        ...
        //此源数组可以在{extends}标记编译时获得额外的元素
		//print_r($this->template->source->smarty->template_objects);
		...
		//对css和js进行提取
		$code = kod_smarty_smarty::compilerIncludeTplHtml($code,$template->template_resource);
