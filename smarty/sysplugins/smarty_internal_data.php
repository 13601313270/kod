...
/**
 * Smarty变量对象类   class for the Smarty variable object
 *
 * 这个类定义了smarty变量对象
 *
 * @package Smarty
...
class Smarty_Variable
{
    ...
    public $value = null;
    /**
     * 如果该值为空，任何关于这个值的输出，将不进行缓存|if true any output of this variable will be not cached
     *
     * @var boolean
     */
    public $nocache = false;
    /**
     * 变量的作用域(local,parent or root)
     *
     * @var int
     */
     ...
     *
     * @param mixed   $value   the value to assign
     * @param boolean $nocache 如果该值为空，任何关于这个值的输出，将不进行缓存
     * @param int     $scope   变量的作用域(local,parent or root)
     */
