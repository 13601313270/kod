...
class Smarty_Internal_Template extends Smarty_Internal_TemplateBase
{
	 ...
	 * 通过tpl文件生成新的可以直接运行的php模板文件，并写入硬盘
     */
    public function compileTemplateSource($display)
    {
    ...
    public function getSubTemplate($template, $cache_id, $compile_id, $caching, $cache_lifetime, $data, $parent_scope)
    {
		...
		//return kod_smarty_smarty::compilerIncludeTplHtml($tpl->fetch(null, null, null, null, false, false, true),$template);
        return $tpl->fetch(null, null, null, null, false, false, true);
    }

    /**
     * 模板代码的运行时函数设置内联模板(include)
	 *
